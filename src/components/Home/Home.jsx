...
import reader from '../Home/reader.json'
    ...
    return (
      ...
      <div className='mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0'>
        ...
        <div className='flex flex-col items-center md:flex-row'>
          ...
          <Link
            to='/about'
            className='inline-flex items-center font-semibold text-gray-800 transition-colors duration-200 hover:text-blue-700 btn2'
          >
            Learn More
          </Link>
        </div>
